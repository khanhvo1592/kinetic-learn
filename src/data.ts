import { Subject, Lesson, Task, QuizQuestion } from './types';
...
export const SUBJECTS: Subject[] = [
  {
    ...
    color: '#2196F3',
    bgColor: '#E3F2FD',
    borderColor: 'border-b-[#2196F3]/30',
    lessonsCount: 124,
    exercisesCount: 45,
  },
  {
    ...
    color: '#9C27B0',
    bgColor: '#F3E5F5',
    borderColor: 'border-b-[#9C27B0]/30',
    lessonsCount: 98,
    exercisesCount: 30,
  },
  {
    ...
    color: '#FF9800',
    bgColor: '#FFF3E0',
    borderColor: 'border-b-[#FF9800]/30',
    lessonsCount: 156,
    exercisesCount: 82,
  },
  {
    ...
    color: '#4CAF50',
    bgColor: '#E8F5E9',
    borderColor: 'border-b-[#4CAF50]/30',
    lessonsCount: 75,
    exercisesCount: 25,
  },
  {
    ...
    color: '#00BCD4',
    bgColor: '#E0F7FA',
    borderColor: 'border-b-[#00BCD4]/30',
    lessonsCount: 82,
    exercisesCount: 35,
  },
  {
    ...
    color: '#FF5722',
    bgColor: '#FBE9E7',
    borderColor: 'border-b-[#FF5722]/30',
    lessonsCount: 64,
    exercisesCount: 20,
  },
];
...
export const RECENT_LESSONS: Lesson[] = [
  {
    ...
    title: 'Toán - Đạo hàm',
    chapter: 'Chương 5: Phép tính vi phân',
    progress: 85,
    duration: '25 phút',
  ...
  },
  {
    ...
    subjectId: 'physics',
    subjectName: 'Vật lý',
    title: 'Quang học cơ bản',
    chapter: 'Chương 4: Khúc xạ ánh sáng',
    progress: 40,
    duration: '30 phút',
  ...
  },
  {
    ...
    chapter: 'Grammar Unit 3: Các thì hiện tại',
    progress: 65,
    duration: '18 phút',
    lastStudied: 'Hôm qua',
...
export const CHEMISTRY_LESSONS: Lesson[] = [
  {
    id: 'chem-atoms',
    subjectId: 'chemistry',
    subjectName: 'Hóa học 8',
    title: 'Bài 1: Cấu tạo nguyên tử',
    chapter: 'Chương 1: Thành phần chất',
    progress: 80,
    duration: '20 phút',
    lastStudied: 'Hôm nay',
    iconBg: 'bg-cyan-100',
    ...
    sections: [
      {
        title: '1. Khái niệm nguyên tử',
        content: 'Nguyên tử là hạt vô cùng nhỏ, trung hòa về điện, cấu tạo nên các chất. Mọi vật thể quanh ta đều được cấu thành từ hàng tỉ tỉ nguyên tử cấu tụ với nhau.'
      },
      {
        title: '2. Cấu tạo chi tiết',
        content: 'Nguyên tử gồm 2 phần chính:\n\n- Hạt nhân (Nucleus): Nằm ở tâm, gồm hạt proton mang điện tích dương (+) và hạt nơtron không mang điện.\n\n- Lớp vỏ (Shell): Gồm các hạt electron mang điện tích âm (-) chuyển động cực nhanh xung quanh hạt nhân và sắp xếp theo từng lớp.'
      },
      {
        title: '3. Khối lượng nguyên tử',
        content: 'Vì khối lượng của hạt nhân lớn hơn rất nhiều so với vỏ eletron (khối lượng hạt e là không đáng kể, xấp xỉ 1/1836 khối lượng proton), do đó khối lượng nguyên tử hầu như tập trung toàn bộ ở hạt nhân.'
      }
    ]
  },
  {
...
export const INITIAL_TASKS: Task[] = [
  {
    id: 'task-1',
    title: 'Hoàn thành 10 câu trắc nghiệm Lý',
    category: 'Vật Lý',
    subInfo: 'Chương 3: Điện học \u2022 Thưởng 50xp',
    xpReward: 50,
    completed: false, userId: "admin",
  },
  {
    id: 'task-2',
    title: 'Đọc chương 2 Sách Ngữ Văn',
    category: 'Ngữ Văn',
    subInfo: 'Đã hoàn thành lúc 08:30 \u2022 Thưởng 30xp',
    xpReward: 30,
    completed: true, userId: "admin",
    completedTime: '08:30',
  },
  {
    id: 'task-3',
    ...
    category: 'Tiếng Anh',
    subInfo: 'Flashcards \u2022 Thưởng 20xp',
    xpReward: 20,
    completed: false, userId: "admin",
  },
];
...
export const ATOM_QUIZ_QUESTIONS: QuizQuestion[] = [
  {
    ...
    correctKey: 'A',
    explanation: 'Sao Thủy (Mercury) là hành tinh nhỏ nhất và nằm gần Mặt Trời nhất trong Hệ Mặt Trời. Vì khoảng cách quá gần, nhiệt độ bề mặt của nó có thể thay đổi cực đoan từ rất nóng vào ban ngày đến rất lạnh vào ban đêm.',
  },
  {
    id: 'q2',
    num: '02',
    ...
    options: [
      { key: 'A', text: 'Điện tích dương' },
      { key: 'B', text: 'Điện tích âm' },
      { key: 'C', text: 'Trung hòa về điện' },
      { key: 'D', text: 'Biến đổi liên tục' }
    ],
    correctKey: 'C',
    explanation: 'Nguyên tử trung hòa về điện do có số proton mang điện tích dương (+) bằng chính xác số electron mang điện tích âm (-) lớp vỏ.',
  },
  {
    id: 'q3',
    num: '03',
    ...
    correctKey: 'A',
    explanation: 'Ký hiệu hóa học O là viết tắt của Oxygen trong tiếng Anh (Oxy). Oxygen là nguyên tố phổ biến thứ ba trong vũ trụ theo khối lượng và chiếm khoảng 21% bầu khí quyển Trái Đất. Ký hiệu của Sắt là Fe và Vàng là Au.',
  },
  {
    id: 'q4',
    num: '04',
    ...
    correctKey: 'B',
    explanation: 'Hạt nhân nguyên tử cấu tạo từ Proton (+) và Nơtron (không mang điện). Các electron (-) chuyển động ở lớp vỏ.',
  },
  {
    id: 'q5',
    num: '05',
    ...
    options: [
      { key: 'A', text: 'Dương (+)' },
      { key: 'B', text: 'Âm (-)' },
      { key: 'C', text: 'Không mang điện' },
      { key: 'D', text: 'Cả hai loại' }
    ],
    correctKey: 'A',
    explanation: 'Hạt proton luôn mang điện tích quy ước là dương (+1), trong khi electron mang điện tích âm (-1).',
  }
];
